...
user_pref("app.update.lastUpdateTime.addon-background-update-timer", 1725945455);
user_pref("app.update.lastUpdateTime.background-update-timer", 1725945455);
user_pref("app.update.lastUpdateTime.browser-cleanup-thumbnails", 1725945455);
user_pref("app.update.lastUpdateTime.region-update-timer", 1725945455);
user_pref("app.update.lastUpdateTime.services-settings-poll-changes", 1725945455);
user_pref("app.update.lastUpdateTime.telemetry_modules_ping", 1725945486);
user_pref("app.update.lastUpdateTime.xpi-signature-verification", 1725945455);
...
user_pref("browser.contextual-services.contextId", "{7cd7721d-1aed-4ee6-b350-969b6d42d36e}");
...
user_pref("browser.newtabpage.activity-stream.impressionId", "{6b182892-fb8d-4246-879a-006808be2aba}");
...
user_pref("browser.startup.lastColdStartupCheck", 1725949122);
...
user_pref("extensions.formautofill.creditCards.reauth.optout", "MDIEEPgAAAAAAAAAAAAAAAAAAAEwFAYIKoZIhvcNAwcECLDe1zKr5D6xBAiCfNDjJ+3Ifw==");
...
user_pref("extensions.webextensions.uuids", "{\"formautofill@mozilla.org\":\"e4ea1429-18b4-48d5-bd0d-d412ec2a07c5\",\"pictureinpicture@mozilla.org\":\"ba05c424-297f-4312-a048-8b694cb08038\",\"screenshots@mozilla.org\":\"ef8484d7-5d55-4f2c-a3d7-6286da4aa8d5\",\"webcompat-reporter@mozilla.org\":\"5725ebd6-baf0-48f4-b814-1e0c967bac65\",\"webcompat@mozilla.org\":\"c418fb22-fb98-4c0e-b02c-ae5c30af8d03\",\"default-theme@mozilla.org\":\"27984db4-fdd7-4ef7-a856-6a624af89429\",\"addons-search-detection@mozilla.com\":\"05d42c9b-05b3-4779-8e41-2e31dca63122\"}");
...
user_pref("security.sandbox.content.tempDirSuffix", "54a14d99-accf-4fa7-b159-5e0582da47c0");
user_pref("services.settings.server", "");
user_pref("signon.autofillForms", false);
user_pref("signon.management.page.os-auth.optout", "MDIEEPgAAAAAAAAAAAAAAAAAAAEwFAYIKoZIhvcNAwcECPKuhfqWE3hRBAgZnRImNHfblA==");
user_pref("signon.rememberSignons", false);
user_pref("startup.homepage_welcome_url", "about:blank");
user_pref("toolkit.cosmeticAnimations.enabled", false);
user_pref("toolkit.shutdown.fastShutdownStage", 3);
user_pref("toolkit.startup.last_success", 1725949121);
