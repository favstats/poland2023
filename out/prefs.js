...
user_pref("app.update.lastUpdateTime.addon-background-update-timer", 1732209644);
user_pref("app.update.lastUpdateTime.background-update-timer", 1732209644);
user_pref("app.update.lastUpdateTime.browser-cleanup-thumbnails", 1732256287);
user_pref("app.update.lastUpdateTime.region-update-timer", 1732080514);
user_pref("app.update.lastUpdateTime.services-settings-poll-changes", 1732209644);
user_pref("app.update.lastUpdateTime.telemetry_modules_ping", 1731694925);
user_pref("app.update.lastUpdateTime.xpi-signature-verification", 1732209644);
...
user_pref("browser.startup.lastColdStartupCheck", 1732256258);
...
user_pref("media.gmp-manager.lastCheck", 1732256745);
user_pref("media.gmp-manager.lastEmptyCheck", 1732256745);
...
user_pref("toolkit.startup.last_success", 1732256255);
