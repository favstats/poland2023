...
user_pref("app.update.lastUpdateTime.addon-background-update-timer", 1724822215);
user_pref("app.update.lastUpdateTime.background-update-timer", 1724822215);
user_pref("app.update.lastUpdateTime.browser-cleanup-thumbnails", 1724822215);
user_pref("app.update.lastUpdateTime.region-update-timer", 1724822215);
user_pref("app.update.lastUpdateTime.services-settings-poll-changes", 1724822215);
user_pref("app.update.lastUpdateTime.telemetry_modules_ping", 1724822245);
user_pref("app.update.lastUpdateTime.xpi-signature-verification", 1724822215);
...
user_pref("browser.contextual-services.contextId", "{3ba49f56-e5dd-4f35-b5a5-49891872bcbb}");
...
user_pref("browser.newtabpage.activity-stream.impressionId", "{06a3becd-d3db-49f8-adce-7e458e70985e}");
...
user_pref("browser.startup.lastColdStartupCheck", 1724825805);
...
user_pref("extensions.formautofill.creditCards.reauth.optout", "MDIEEPgAAAAAAAAAAAAAAAAAAAEwFAYIKoZIhvcNAwcECA2Kjaga7kgyBAjtesTMY4FFaw==");
...
user_pref("extensions.webextensions.uuids", "{\"formautofill@mozilla.org\":\"e09c1d22-0d20-4592-9751-d160dc1cb75b\",\"pictureinpicture@mozilla.org\":\"9e821885-052a-4195-b31d-f6aaf9207c25\",\"screenshots@mozilla.org\":\"5104d4f9-c79f-4f38-ad5e-b61e9d1809d4\",\"webcompat-reporter@mozilla.org\":\"411dbeb9-1b3f-4175-98d7-7141576ccdd8\",\"webcompat@mozilla.org\":\"853aa6c9-f1ae-4427-ab0a-0c8a68e2d5c2\",\"default-theme@mozilla.org\":\"821eff61-8bbb-451e-aa41-7f725c493cd9\",\"addons-search-detection@mozilla.com\":\"313bd223-7030-479f-bed9-9ea4022abbc1\"}");
...
user_pref("security.sandbox.content.tempDirSuffix", "b6b35205-1e5e-497b-9774-de6ed20bf68d");
user_pref("services.settings.server", "");
user_pref("signon.autofillForms", false);
user_pref("signon.management.page.os-auth.optout", "MDIEEPgAAAAAAAAAAAAAAAAAAAEwFAYIKoZIhvcNAwcECK3PjkWBWMGEBAhy5x+dE2xGcg==");
user_pref("signon.rememberSignons", false);
user_pref("startup.homepage_welcome_url", "about:blank");
user_pref("toolkit.cosmeticAnimations.enabled", false);
user_pref("toolkit.shutdown.fastShutdownStage", 3);
user_pref("toolkit.startup.last_success", 1724825802);
