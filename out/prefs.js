...
user_pref("app.update.lastUpdateTime.addon-background-update-timer", 1725427348);
user_pref("app.update.lastUpdateTime.background-update-timer", 1725427348);
user_pref("app.update.lastUpdateTime.browser-cleanup-thumbnails", 1725427348);
user_pref("app.update.lastUpdateTime.region-update-timer", 1725427348);
user_pref("app.update.lastUpdateTime.services-settings-poll-changes", 1725427348);
user_pref("app.update.lastUpdateTime.telemetry_modules_ping", 1725427377);
user_pref("app.update.lastUpdateTime.xpi-signature-verification", 1725427348);
...
user_pref("browser.contextual-services.contextId", "{c5d0d26c-dfa3-473b-bb22-69393efbc715}");
...
user_pref("browser.newtabpage.activity-stream.impressionId", "{aa364478-3ac1-45ce-b893-bc5953ab64b3}");
...
user_pref("browser.startup.lastColdStartupCheck", 1725430621);
...
user_pref("extensions.formautofill.creditCards.reauth.optout", "MDIEEPgAAAAAAAAAAAAAAAAAAAEwFAYIKoZIhvcNAwcECPNxHk+94Pg3BAiw6c31qioZLQ==");
...
user_pref("extensions.webextensions.uuids", "{\"formautofill@mozilla.org\":\"b06982a1-558d-4dd7-8a15-38fbf8bfcf97\",\"pictureinpicture@mozilla.org\":\"09bddd9a-974a-4db4-8a5f-9d88518cdc00\",\"screenshots@mozilla.org\":\"b60e5359-3e5d-4174-b701-d023ea32b1e9\",\"webcompat-reporter@mozilla.org\":\"02071719-940b-4746-84f7-d2b93893a6d9\",\"webcompat@mozilla.org\":\"9496f08d-2772-43e6-9ab8-bd4c55809124\",\"default-theme@mozilla.org\":\"f05cf6a4-4d1c-42b8-bba6-262fde3ce687\",\"addons-search-detection@mozilla.com\":\"05a5d9b6-2aae-4982-8ab7-f02cf43033c8\"}");
...
user_pref("security.sandbox.content.tempDirSuffix", "ed894ab5-ec1d-415e-9f4e-05eac7da6ce0");
user_pref("services.settings.server", "");
user_pref("signon.autofillForms", false);
user_pref("signon.management.page.os-auth.optout", "MDIEEPgAAAAAAAAAAAAAAAAAAAEwFAYIKoZIhvcNAwcECLaBsXHlngEQBAgTB33kuQfwOQ==");
user_pref("signon.rememberSignons", false);
user_pref("startup.homepage_welcome_url", "about:blank");
user_pref("toolkit.cosmeticAnimations.enabled", false);
user_pref("toolkit.shutdown.fastShutdownStage", 3);
user_pref("toolkit.startup.last_success", 1725430618);
