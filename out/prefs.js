...
user_pref("app.update.lastUpdateTime.addon-background-update-timer", 1725081560);
user_pref("app.update.lastUpdateTime.background-update-timer", 1725081560);
user_pref("app.update.lastUpdateTime.browser-cleanup-thumbnails", 1725081560);
user_pref("app.update.lastUpdateTime.region-update-timer", 1725081560);
user_pref("app.update.lastUpdateTime.services-settings-poll-changes", 1725081560);
user_pref("app.update.lastUpdateTime.telemetry_modules_ping", 1725081588);
user_pref("app.update.lastUpdateTime.xpi-signature-verification", 1725081560);
...
user_pref("browser.contextual-services.contextId", "{307b9a9a-5ef2-4052-8461-a49d4a6fe552}");
...
user_pref("browser.newtabpage.activity-stream.impressionId", "{5786a5f6-8459-4106-bdc2-0eb97eb679af}");
...
user_pref("browser.startup.lastColdStartupCheck", 1725084995);
...
user_pref("extensions.formautofill.creditCards.reauth.optout", "MDIEEPgAAAAAAAAAAAAAAAAAAAEwFAYIKoZIhvcNAwcECJsZ3rcbBhZuBAgvaUYBWlP83A==");
...
user_pref("extensions.webextensions.uuids", "{\"formautofill@mozilla.org\":\"7992eb27-c1a4-4a6f-9985-f66106d8b504\",\"pictureinpicture@mozilla.org\":\"490561f9-c78c-40cd-9b1c-3a0cbd0e092c\",\"screenshots@mozilla.org\":\"a9517f3c-dbad-4ed4-9276-7774f256260a\",\"webcompat-reporter@mozilla.org\":\"65e73022-1e26-49fe-9b0c-91f33b92850a\",\"webcompat@mozilla.org\":\"bf87dce0-f2e8-4727-a06d-0328257cd4d9\",\"default-theme@mozilla.org\":\"ebb8baf9-1fc8-4e11-8a9c-2e68c1463c4f\",\"addons-search-detection@mozilla.com\":\"37293e73-c3d8-4a43-b4dc-bb9a3c1c265c\"}");
...
user_pref("security.sandbox.content.tempDirSuffix", "d9165223-463e-440b-878a-6e876002e328");
user_pref("services.settings.server", "");
user_pref("signon.autofillForms", false);
user_pref("signon.management.page.os-auth.optout", "MDIEEPgAAAAAAAAAAAAAAAAAAAEwFAYIKoZIhvcNAwcECNFb4JUYvRyGBAjcmb3H1U61RA==");
user_pref("signon.rememberSignons", false);
user_pref("startup.homepage_welcome_url", "about:blank");
user_pref("toolkit.cosmeticAnimations.enabled", false);
user_pref("toolkit.shutdown.fastShutdownStage", 3);
user_pref("toolkit.startup.last_success", 1725084992);
