...
user_pref("app.update.lastUpdateTime.addon-background-update-timer", 1726550160);
user_pref("app.update.lastUpdateTime.background-update-timer", 1726550160);
user_pref("app.update.lastUpdateTime.browser-cleanup-thumbnails", 1726550160);
user_pref("app.update.lastUpdateTime.region-update-timer", 1726550160);
user_pref("app.update.lastUpdateTime.services-settings-poll-changes", 1726550160);
user_pref("app.update.lastUpdateTime.telemetry_modules_ping", 1726550190);
user_pref("app.update.lastUpdateTime.xpi-signature-verification", 1726550160);
...
user_pref("browser.contextual-services.contextId", "{a920eaa3-299a-49fd-8d1b-e9481ba38c66}");
...
user_pref("browser.newtabpage.activity-stream.impressionId", "{4bb24286-3771-4f14-8229-9ac4cc30a667}");
...
user_pref("browser.startup.lastColdStartupCheck", 1726553789);
...
user_pref("extensions.formautofill.creditCards.reauth.optout", "MDIEEPgAAAAAAAAAAAAAAAAAAAEwFAYIKoZIhvcNAwcECF2AfoPTEU2wBAixX8wUvrSZtw==");
...
user_pref("extensions.webextensions.uuids", "{\"formautofill@mozilla.org\":\"6b744abf-92a5-4255-a437-63c7ea93e2aa\",\"pictureinpicture@mozilla.org\":\"3d2325df-5ee2-4493-91cb-7e8468a0f89e\",\"screenshots@mozilla.org\":\"941ebf6d-4cc5-4bbb-aea7-afdb79a82814\",\"webcompat-reporter@mozilla.org\":\"cb338642-e039-4447-b217-76ec3497f91e\",\"webcompat@mozilla.org\":\"743efaa7-8d99-43fa-8281-7de1c1d55292\",\"default-theme@mozilla.org\":\"a5639eea-5c3e-4817-86c6-c5075111075f\",\"addons-search-detection@mozilla.com\":\"8f9e6d42-28dd-4196-b8d5-5aae1785baa9\"}");
...
user_pref("security.sandbox.content.tempDirSuffix", "d4512dd1-1752-4df2-b0bc-e3cf42750058");
user_pref("security.sandbox.warn_unprivileged_namespaces", false);
user_pref("services.settings.server", "");
user_pref("signon.autofillForms", false);
user_pref("signon.management.page.os-auth.optout", "MDIEEPgAAAAAAAAAAAAAAAAAAAEwFAYIKoZIhvcNAwcECPdDTi68wZ+RBAhoDwey/JYFxA==");
user_pref("signon.rememberSignons", false);
user_pref("startup.homepage_welcome_url", "about:blank");
user_pref("toolkit.cosmeticAnimations.enabled", false);
user_pref("toolkit.shutdown.fastShutdownStage", 3);
user_pref("toolkit.startup.last_success", 1726553787);
