...
user_pref("app.update.lastUpdateTime.addon-background-update-timer", 1724045014);
user_pref("app.update.lastUpdateTime.background-update-timer", 1724045014);
user_pref("app.update.lastUpdateTime.browser-cleanup-thumbnails", 1724045014);
user_pref("app.update.lastUpdateTime.region-update-timer", 1724045014);
user_pref("app.update.lastUpdateTime.services-settings-poll-changes", 1724045014);
user_pref("app.update.lastUpdateTime.telemetry_modules_ping", 1724045043);
user_pref("app.update.lastUpdateTime.xpi-signature-verification", 1724045014);
...
user_pref("browser.contextual-services.contextId", "{5e97f1ed-e8a5-461e-ad08-921933121e25}");
...
user_pref("browser.newtabpage.activity-stream.impressionId", "{3562b7d8-4b59-4df5-b347-5906cc728383}");
...
user_pref("browser.startup.lastColdStartupCheck", 1724048241);
...
user_pref("extensions.formautofill.creditCards.reauth.optout", "MDIEEPgAAAAAAAAAAAAAAAAAAAEwFAYIKoZIhvcNAwcECNMXUIJoniYcBAgzPzLnzK4e6g==");
...
user_pref("extensions.webextensions.uuids", "{\"formautofill@mozilla.org\":\"da8d4268-c782-434d-90a6-8ea0156f0839\",\"pictureinpicture@mozilla.org\":\"d8a3af46-8130-448e-be9e-7e541051f3fa\",\"screenshots@mozilla.org\":\"f66ea6b8-2cd6-41d3-b8e7-698ba51c24b2\",\"webcompat-reporter@mozilla.org\":\"b982124c-8b7b-440c-8a2f-e652ff1540d4\",\"webcompat@mozilla.org\":\"cb70c46d-9d45-467a-8b06-c7a436a9e89f\",\"default-theme@mozilla.org\":\"e6d8f3a2-ec87-458d-a331-cf77036d2636\",\"addons-search-detection@mozilla.com\":\"f4ff9dfa-2e86-429b-b832-f47d1a7146c7\"}");
...
user_pref("security.sandbox.content.tempDirSuffix", "a07190df-9962-4eb8-a35f-8eb9ad1aae02");
user_pref("services.settings.server", "");
user_pref("signon.autofillForms", false);
user_pref("signon.management.page.os-auth.optout", "MDIEEPgAAAAAAAAAAAAAAAAAAAEwFAYIKoZIhvcNAwcECC/EYztFySwDBAhW+SzQa6goOQ==");
user_pref("signon.rememberSignons", false);
user_pref("startup.homepage_welcome_url", "about:blank");
user_pref("toolkit.cosmeticAnimations.enabled", false);
user_pref("toolkit.shutdown.fastShutdownStage", 3);
user_pref("toolkit.startup.last_success", 1724048239);
