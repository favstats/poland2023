...
user_pref("app.update.lastUpdateTime.addon-background-update-timer", 1726204602);
user_pref("app.update.lastUpdateTime.background-update-timer", 1726204602);
user_pref("app.update.lastUpdateTime.browser-cleanup-thumbnails", 1726204602);
user_pref("app.update.lastUpdateTime.region-update-timer", 1726204602);
user_pref("app.update.lastUpdateTime.services-settings-poll-changes", 1726204602);
user_pref("app.update.lastUpdateTime.telemetry_modules_ping", 1726204631);
user_pref("app.update.lastUpdateTime.xpi-signature-verification", 1726204602);
...
user_pref("browser.contextual-services.contextId", "{caf96e98-307a-4ff3-b72c-7a75c83a609a}");
...
user_pref("browser.newtabpage.activity-stream.impressionId", "{236592c9-63d4-444d-ad8a-f0c3e6b9f5d8}");
...
user_pref("browser.startup.lastColdStartupCheck", 1726208225);
...
user_pref("extensions.formautofill.creditCards.reauth.optout", "MDIEEPgAAAAAAAAAAAAAAAAAAAEwFAYIKoZIhvcNAwcECDGjM70iE7TTBAgj6WR7tTdL8w==");
...
user_pref("extensions.webextensions.uuids", "{\"formautofill@mozilla.org\":\"65b27730-8474-46cc-9252-0a703699b1ef\",\"pictureinpicture@mozilla.org\":\"f597f5ed-de52-45f7-92cc-07c4ec1bca71\",\"screenshots@mozilla.org\":\"d9675154-0d8d-4b73-9fd5-422c493b2da4\",\"webcompat-reporter@mozilla.org\":\"8e26b033-1318-4765-92fa-94795c2dd160\",\"webcompat@mozilla.org\":\"cd03d0f9-4c5a-4167-8f89-9250dac5d1cf\",\"default-theme@mozilla.org\":\"859600c1-0004-4fb6-b0dd-88a56ea6c579\",\"addons-search-detection@mozilla.com\":\"e9e3def4-4b2a-4745-8585-a962696fec4b\"}");
...
user_pref("security.sandbox.content.tempDirSuffix", "ba2e53b7-9b0c-4471-8ff7-699b8d2e85c0");
user_pref("security.sandbox.warn_unprivileged_namespaces", false);
user_pref("services.settings.server", "");
user_pref("signon.autofillForms", false);
user_pref("signon.management.page.os-auth.optout", "MDIEEPgAAAAAAAAAAAAAAAAAAAEwFAYIKoZIhvcNAwcECOAZAsjBQTrdBAgtses0eYgkcA==");
user_pref("signon.rememberSignons", false);
user_pref("startup.homepage_welcome_url", "about:blank");
user_pref("toolkit.cosmeticAnimations.enabled", false);
user_pref("toolkit.shutdown.fastShutdownStage", 3);
user_pref("toolkit.startup.last_success", 1726208224);
