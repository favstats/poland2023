...
user_pref("app.update.lastUpdateTime.addon-background-update-timer", 1723871860);
user_pref("app.update.lastUpdateTime.background-update-timer", 1723871860);
user_pref("app.update.lastUpdateTime.browser-cleanup-thumbnails", 1723871860);
user_pref("app.update.lastUpdateTime.region-update-timer", 1723871860);
user_pref("app.update.lastUpdateTime.services-settings-poll-changes", 1723871860);
user_pref("app.update.lastUpdateTime.telemetry_modules_ping", 1723871888);
user_pref("app.update.lastUpdateTime.xpi-signature-verification", 1723871860);
...
user_pref("browser.contextual-services.contextId", "{a872c5d5-7862-4eda-b1f1-29f377bb3180}");
...
user_pref("browser.newtabpage.activity-stream.impressionId", "{61fb1212-4234-4fe8-8ba0-f81893b2a083}");
...
user_pref("browser.startup.lastColdStartupCheck", 1723875375);
...
user_pref("extensions.formautofill.creditCards.reauth.optout", "MDIEEPgAAAAAAAAAAAAAAAAAAAEwFAYIKoZIhvcNAwcECLd/L28qX/kJBAhXjxqmyMaeBA==");
...
user_pref("extensions.webextensions.uuids", "{\"formautofill@mozilla.org\":\"6d9bf119-5311-4596-a935-8cedfd866dc1\",\"pictureinpicture@mozilla.org\":\"c7f9a473-df70-4325-89d5-d54cd8888b07\",\"screenshots@mozilla.org\":\"8af2d356-92da-4aca-957c-577ae9873ee8\",\"webcompat-reporter@mozilla.org\":\"d5265b01-2d15-4ddb-9998-ca1a608fc5e2\",\"webcompat@mozilla.org\":\"08e3d97f-6d50-43fe-90fd-3a8079cb4de2\",\"default-theme@mozilla.org\":\"e897e322-5f4b-4ea3-b905-9342568c833f\",\"addons-search-detection@mozilla.com\":\"bd3852f5-981c-4b51-a8af-6d5dce7b4681\"}");
...
user_pref("security.sandbox.content.tempDirSuffix", "9d4e7c34-eae4-4902-ad6b-2db57bc63682");
user_pref("services.settings.server", "");
user_pref("signon.autofillForms", false);
user_pref("signon.management.page.os-auth.optout", "MDIEEPgAAAAAAAAAAAAAAAAAAAEwFAYIKoZIhvcNAwcECOObfVt1CgGHBAgEbuNs+O/iVw==");
user_pref("signon.rememberSignons", false);
user_pref("startup.homepage_welcome_url", "about:blank");
user_pref("toolkit.cosmeticAnimations.enabled", false);
user_pref("toolkit.shutdown.fastShutdownStage", 3);
user_pref("toolkit.startup.last_success", 1723875372);
