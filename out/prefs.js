...
user_pref("app.update.lastUpdateTime.addon-background-update-timer", 1726463907);
user_pref("app.update.lastUpdateTime.background-update-timer", 1726463907);
user_pref("app.update.lastUpdateTime.browser-cleanup-thumbnails", 1726463907);
user_pref("app.update.lastUpdateTime.region-update-timer", 1726463907);
user_pref("app.update.lastUpdateTime.services-settings-poll-changes", 1726463907);
user_pref("app.update.lastUpdateTime.telemetry_modules_ping", 1726463935);
user_pref("app.update.lastUpdateTime.xpi-signature-verification", 1726463907);
...
user_pref("browser.contextual-services.contextId", "{c181fa09-99bd-4a00-ab3b-0e678583dbfc}");
...
user_pref("browser.newtabpage.activity-stream.impressionId", "{4e6bf599-3257-4985-9b39-ac4aff3da67d}");
...
user_pref("browser.startup.lastColdStartupCheck", 1726467476);
...
user_pref("extensions.formautofill.creditCards.reauth.optout", "MDIEEPgAAAAAAAAAAAAAAAAAAAEwFAYIKoZIhvcNAwcECBCTPTxBD0iKBAg1KMrDS5ewzw==");
...
user_pref("extensions.webextensions.uuids", "{\"formautofill@mozilla.org\":\"8d385b8f-d8e0-4803-9c3e-5b8dbe5b93ff\",\"pictureinpicture@mozilla.org\":\"95a6252b-dded-4f14-ad8e-61c135399e40\",\"screenshots@mozilla.org\":\"f314b134-5ffc-4fda-b989-31c22a819a5a\",\"webcompat-reporter@mozilla.org\":\"8fa09c62-1260-4c81-8661-6a36d7564bef\",\"webcompat@mozilla.org\":\"37949228-6ff5-4137-8bd6-720e2e8e37fe\",\"default-theme@mozilla.org\":\"57687a61-01aa-4d25-b0b3-8d14dfe073fa\",\"addons-search-detection@mozilla.com\":\"163ca22f-3ab4-4f2a-b3b0-48ff470ca1a7\"}");
...
user_pref("security.sandbox.content.tempDirSuffix", "c1c54f07-0e94-4139-a528-1c5e9a8dc9f3");
user_pref("security.sandbox.warn_unprivileged_namespaces", false);
user_pref("services.settings.server", "");
user_pref("signon.autofillForms", false);
user_pref("signon.management.page.os-auth.optout", "MDIEEPgAAAAAAAAAAAAAAAAAAAEwFAYIKoZIhvcNAwcECBf3BLeYWa0uBAhdWoOwMtMz0w==");
user_pref("signon.rememberSignons", false);
user_pref("startup.homepage_welcome_url", "about:blank");
user_pref("toolkit.cosmeticAnimations.enabled", false);
user_pref("toolkit.shutdown.fastShutdownStage", 3);
user_pref("toolkit.startup.last_success", 1726467473);
