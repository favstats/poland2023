...
user_pref("app.update.lastUpdateTime.addon-background-update-timer", 1726377350);
user_pref("app.update.lastUpdateTime.background-update-timer", 1726377350);
user_pref("app.update.lastUpdateTime.browser-cleanup-thumbnails", 1726377350);
user_pref("app.update.lastUpdateTime.region-update-timer", 1726377350);
user_pref("app.update.lastUpdateTime.services-settings-poll-changes", 1726377350);
user_pref("app.update.lastUpdateTime.telemetry_modules_ping", 1726377379);
user_pref("app.update.lastUpdateTime.xpi-signature-verification", 1726377350);
...
user_pref("browser.contextual-services.contextId", "{8f2e977a-a6ce-4916-97ff-f9f8dbb58595}");
...
user_pref("browser.newtabpage.activity-stream.impressionId", "{f6e168a0-3aa1-4b67-a74d-1f3360817245}");
...
user_pref("browser.startup.lastColdStartupCheck", 1726381003);
...
user_pref("extensions.formautofill.creditCards.reauth.optout", "MDIEEPgAAAAAAAAAAAAAAAAAAAEwFAYIKoZIhvcNAwcECIwv2F1RwyUWBAiOrmLbXK0phw==");
...
user_pref("extensions.webextensions.uuids", "{\"formautofill@mozilla.org\":\"cb74f390-a187-4346-9017-1a3c74255011\",\"pictureinpicture@mozilla.org\":\"ea92c9a7-2c8c-4d29-9e72-5b82654d8b96\",\"screenshots@mozilla.org\":\"3459bdeb-0f1e-4cf4-ae62-378ce77963e6\",\"webcompat-reporter@mozilla.org\":\"f14cf79a-a20b-48e4-8a50-78ad2fe30407\",\"webcompat@mozilla.org\":\"90a2f899-c15b-40a4-b359-aba9c15a497c\",\"default-theme@mozilla.org\":\"6d077464-843e-4903-84a9-ac94c31a26c5\",\"addons-search-detection@mozilla.com\":\"5f2980b7-8fa6-4a08-9eb7-d07076564518\"}");
...
user_pref("security.sandbox.content.tempDirSuffix", "cecddfa2-f948-4b0c-a3f5-8fa4e1c2d8ec");
user_pref("security.sandbox.warn_unprivileged_namespaces", false);
user_pref("services.settings.server", "");
user_pref("signon.autofillForms", false);
user_pref("signon.management.page.os-auth.optout", "MDIEEPgAAAAAAAAAAAAAAAAAAAEwFAYIKoZIhvcNAwcECItXNMIkS55CBAg+IoQhIdoIFQ==");
user_pref("signon.rememberSignons", false);
user_pref("startup.homepage_welcome_url", "about:blank");
user_pref("toolkit.cosmeticAnimations.enabled", false);
user_pref("toolkit.shutdown.fastShutdownStage", 3);
user_pref("toolkit.startup.last_success", 1726381001);
