...
user_pref("app.update.lastUpdateTime.addon-background-update-timer", 1726290977);
user_pref("app.update.lastUpdateTime.background-update-timer", 1726290977);
user_pref("app.update.lastUpdateTime.browser-cleanup-thumbnails", 1726290977);
user_pref("app.update.lastUpdateTime.region-update-timer", 1726290977);
user_pref("app.update.lastUpdateTime.services-settings-poll-changes", 1726290977);
user_pref("app.update.lastUpdateTime.telemetry_modules_ping", 1726291006);
user_pref("app.update.lastUpdateTime.xpi-signature-verification", 1726290977);
...
user_pref("browser.contextual-services.contextId", "{44015b22-030c-4ce8-8bbd-45707490dac3}");
...
user_pref("browser.newtabpage.activity-stream.impressionId", "{a3360a2f-8d51-4341-b866-1fff0a309811}");
...
user_pref("browser.startup.lastColdStartupCheck", 1726294575);
...
user_pref("extensions.formautofill.creditCards.reauth.optout", "MDIEEPgAAAAAAAAAAAAAAAAAAAEwFAYIKoZIhvcNAwcECAnADydXJHu+BAj9uLdR7R5F/w==");
...
user_pref("extensions.webextensions.uuids", "{\"formautofill@mozilla.org\":\"026e9d34-65d0-421d-9a0b-749e7dcdcd73\",\"pictureinpicture@mozilla.org\":\"79c52f8a-dab9-4952-9868-c37b16155da0\",\"screenshots@mozilla.org\":\"b8fe2d04-bf2b-4db5-9f64-bc26d92390fd\",\"webcompat-reporter@mozilla.org\":\"022dd775-43a3-4828-af2a-508cb1d6b55d\",\"webcompat@mozilla.org\":\"93687a49-25bd-4a88-abe2-e2dfe4b5b4ce\",\"default-theme@mozilla.org\":\"e10137e7-c3c4-41c1-9f1c-09e74577149e\",\"addons-search-detection@mozilla.com\":\"3694baa6-2893-47f8-be40-58dcb64928db\"}");
...
user_pref("security.sandbox.content.tempDirSuffix", "5ec51ddc-c49b-4a1f-9696-2c6f47e9c680");
user_pref("security.sandbox.warn_unprivileged_namespaces", false);
user_pref("services.settings.server", "");
user_pref("signon.autofillForms", false);
user_pref("signon.management.page.os-auth.optout", "MDIEEPgAAAAAAAAAAAAAAAAAAAEwFAYIKoZIhvcNAwcECJUyJfKKsLrBBAhhIQ0KB+XabA==");
user_pref("signon.rememberSignons", false);
user_pref("startup.homepage_welcome_url", "about:blank");
user_pref("toolkit.cosmeticAnimations.enabled", false);
user_pref("toolkit.shutdown.fastShutdownStage", 3);
user_pref("toolkit.startup.last_success", 1726294572);
