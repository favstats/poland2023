...
user_pref("app.update.lastUpdateTime.addon-background-update-timer", 1725340827);
user_pref("app.update.lastUpdateTime.background-update-timer", 1725340827);
user_pref("app.update.lastUpdateTime.browser-cleanup-thumbnails", 1725340827);
user_pref("app.update.lastUpdateTime.region-update-timer", 1725340827);
user_pref("app.update.lastUpdateTime.services-settings-poll-changes", 1725340827);
user_pref("app.update.lastUpdateTime.telemetry_modules_ping", 1725340855);
user_pref("app.update.lastUpdateTime.xpi-signature-verification", 1725340827);
...
user_pref("browser.contextual-services.contextId", "{58e332aa-d178-4d7f-84f1-84338476ae21}");
...
user_pref("browser.newtabpage.activity-stream.impressionId", "{dd72eaaa-3dab-4a1c-92c7-338ba34bbe08}");
...
user_pref("browser.startup.lastColdStartupCheck", 1725344209);
...
user_pref("extensions.formautofill.creditCards.reauth.optout", "MDIEEPgAAAAAAAAAAAAAAAAAAAEwFAYIKoZIhvcNAwcECBWudskm1xOsBAievyAylZw9PQ==");
...
user_pref("extensions.webextensions.uuids", "{\"formautofill@mozilla.org\":\"a491e7a5-c4df-43f5-a300-7cd5281a7ea4\",\"pictureinpicture@mozilla.org\":\"d974925e-c1c0-42a6-aa0f-41d860bcffd0\",\"screenshots@mozilla.org\":\"02dfc361-0ce6-45f5-bb31-d2c6f31adf8a\",\"webcompat-reporter@mozilla.org\":\"a5afebcd-d6f0-445e-8418-f77863a0616a\",\"webcompat@mozilla.org\":\"4df099f9-e3e7-45c8-8add-659ed456341c\",\"default-theme@mozilla.org\":\"bcc6a994-61af-46eb-8a4e-7e62dcf1e975\",\"addons-search-detection@mozilla.com\":\"19af0677-8c67-4f39-adf1-c67e655228ea\"}");
...
user_pref("security.sandbox.content.tempDirSuffix", "30ca89ae-d4a7-4398-93f4-ba6a27ab121c");
user_pref("services.settings.server", "");
user_pref("signon.autofillForms", false);
user_pref("signon.management.page.os-auth.optout", "MDIEEPgAAAAAAAAAAAAAAAAAAAEwFAYIKoZIhvcNAwcECBKwsltp7MwvBAjpMekQJU1vJA==");
user_pref("signon.rememberSignons", false);
user_pref("startup.homepage_welcome_url", "about:blank");
user_pref("toolkit.cosmeticAnimations.enabled", false);
user_pref("toolkit.shutdown.fastShutdownStage", 3);
user_pref("toolkit.startup.last_success", 1725344206);
